Gem::Specification.new do |s|
  ...
  s.description = "A full featured terminal browser with syntax highlighted files, images shown in the terminal, videos thumbnailed, etc. You can bookmark and jump around easily, delete, rename, copy, symlink and move files. RTFM has a a wide range of other features. New in 3.30: Updated default OpenAI model and adding the option to add own by setting @aimodel in .rtfm.conf."
